...
function AddProperty() {
  ...
  const {
    ...
    onSubmit: (values) => {
      let updatedData = {
        ...values,
        user:
          userData && userData?.agency?.user
            ? userData?.agency?.user
            : user?.id,
        staff: userData && userData?.agency?.user ? user?.id : null,
        price:
          values?.price ||
          values?.monthlyRent ||
      ...
      try {
        setIsLoading(true);
        dispatch(addProperty(updatedData)).then((res) => {
          // onClose();
          resetForm();
          setIsLoading(false);
        });
  ...
  const onListingExpiryChange = (date, dateString) => {
    setValues({ ...values, listingExpiry: dateString });
  };
  ...
  useEffect(() => {
    ...
    setFeatureNames(featureNamesFields);
    // console.log("featureNamesFieldsfeatureNamesFields", featureNamesFields);
          ...
          >
            ...
            <div className={classes.input_field_container}>
              ...
              {/* <DatePicker
                ...
                onChange={onListingExpiryChange}
                type="text"
              /> */}
              <div className={classes.styles_select}>
                <select
            ...
            >
              ...
              <div className={classes.input_field_container}>
                ...
                <input
                  ...
                  id="minContractPeriod"
                  value={values.minContractPeriod}
                  onChange={handleChange}
                  // onBlur={handleBlur}
                  className={`${classes.input_field} ${
                    errors.minContractPeriod && classes.error_field
                  }`}
                />
              </div>
              <div className={classes.checkbox_option}>
