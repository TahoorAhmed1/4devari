...
const BuilderAccountSetting = () => {
  ...
  const userFormik = useFormik({
    ...
    validationSchema: builderSettingSchema,
    onSubmit: () => {
      if (userId) {
  ...
  const profileFormik = useFormik({
    ...
    validationSchema: builderProfileSchema,
    onSubmit: () => {
      if (userId) {
  ...
  useEffect(() => {
    if (userInfo) {
      userFormik.setValues({
        ...
        builderLogo: userData?.builderLogo,
      });
      ...
      if (info.file.status === "done") {
        ...
        dispatch(uploadImages(formData)).then((res) => {
          if (res?.payload?.secure_url) {
            ...
            userFormik.setValues({ ...userFormik.values, builderLogo: img });
            setDisableBtn(false);
  ...
  return (
    <div className="main_setting_container">
      ...
      <h3 className="mob_heading d_none">Builder Account Settings</h3>
      <div className="content_container">
        <div className="left_container">
          ...
          <div className="info_container">
            <Image
              src={userFormik?.values?.builderLogo || profileImg}
              width={70}
              height={70}
            />
          ...
          <div className="form_container">
            ...
            <div className="upload_field_container">
              ...
              <div
                className={`upload_btn ${
                  isFieldError("builderLogo", userFormik) ? "err_field" : ""
                }`}
              >
            ...
            <div className="dual_container">
              <div className="input_field_container">
                ...
                <input
                  ...
                  placeholder="Full Name"
                  name="builderName"
                  value={profileFormik.values?.builderName}
                  onChange={profileFormik.handleChange}
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("builderName", profileFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
            ...
            <div className="dual_container">
              <div className="input_field_container">
                <>
                  <p className="label">Operating In Cities</p>
                  <MutiSelect
                    placeholder="Enter your current country"
                    name="operatingCities"
                    value={profileFormik.values.operatingCities}
                    onChange={profileFormik.handleChange}
                    onBlur={profileFormik.handleBlur}
                    error={isFieldError("operatingCities", profileFormik)}
                    options={allCitites}
                    labelVal="name"
                    labelKey="name"
                  />
            ...
            <div className="input_field_container ">
              <>
                ...
                <textarea
                  ...
                  name="aboutUs"
                  value={profileFormik.values.aboutUs}
                  onChange={profileFormik.handleChange}
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("aboutUs", profileFormik)
            ...
            <div className="dual_container">
              <div className="input_field_container">
                <>
                  ...
                  <MultiTextChip
                    placeholder="Enter one or more owners"
                    name="owners"
                    value={profileFormik.values.owners}
                    onValueChange={profileFormik.handleChange}
                    onBlur={profileFormik.handleBlur}
                    className={
                      isFieldError("owners", profileFormik)
                        ? "err_field"
                        : ""
                    }
                   />
              ...
              <div className="input_field_container">
                <>
                  ...
                  <MultiTextChip
                    placeholder="Enter your partners"
                    name="partners"
                    value={profileFormik.values.partners}
                    onValueChange={profileFormik.handleChange}
                    onBlur={profileFormik.handleBlur}
                    className={
                      isFieldError("partners", profileFormik)
                        ? "err_field"
                        : ""
                    }
                  />
              ...
              <div className="input_field_container">
                <>
                  ...
                  <input
                    ...
                    onBlur={profileFormik.handleBlur}
                    className={
                      isFieldError("cnic", profileFormik)
                        ? "err_field input_field"
                        : "input_field"
                    }
                  />
            ...
            <div className="upload_field_container">
              ...
              <div
                className={`upload_btn ${
                  isFieldError("builderCoverPicture", profileFormik) ? "err_field" : ""
                }`}
              >
...
export default BuilderAccountSetting;
