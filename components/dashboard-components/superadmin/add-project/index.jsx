...
import { addProject } from "../../../../redux/property";
...
function AddProject() {
  ...
  const { values, handleSubmit, setValues, errors, setErrors, resetForm } =
    useFormik({
      ...
      onSubmit: (values) => {
        ...
        try {
          setIsLoading(true);
          dispatch(addProject(updatedData)).then((res) => {
            onClose();
            resetForm();
            setIsLoading(false);
            message.success(`Project added Successfully`);
            router.push("/dashboard/superadmin/project");
          });
        } catch (error) {
          setIsLoading(false);
          ...
          >
            ...
            <div className={classes.upload_field_container}>
              ...
              <div className={classes.upload_btn}>
                <Upload multiple {...LogoProps} name="images">
                  <Button
