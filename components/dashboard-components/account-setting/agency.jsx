...
import { signUpAsStaffUser } from "../../../api/auth/auth";
...
const AgencyAccountSetting = () => {
  const dispatch = useDispatch();
  const allCitites = City.getCitiesOfCountry("PK");
  const [settingbtn, setSettingbtn] = useState(1);
  const [disbleBtn, setDisableBtn] = useState(false);
  const { user } = useAuth();
  // console.log(user);
  const userId = user?.id;
  const { userData, loadingUser, agentData } = useSelector(
    (state) => state.users
  );
  ...
  const userFormik = useFormik({
    ...
    validationSchema: agencySettingSchema,
    onSubmit: () => {
      if (userId) {
  ...
  const ceoFormik = useFormik({
    initialValues: ceoValues,
    validationSchema: agencyCeoSchema,
    onSubmit: () => {
      if (userId) {
        const data = { ...ceoFormik.values };
        delete data._id;
        delete data.user;
        setDisableBtn(true);
        dispatch(
  ...
  const agentFormik = useFormik({
    ...
    validationSchema: agencyStaffSchema,
    onSubmit: async () => {
      setDisableBtn(true);
      const req = await signUpAsStaffUser({
        agency: userData?._id,
        username: agentFormik?.values?.username,
        email: agentFormik?.values?.email,
        password: agentFormik?.values?.password,
        mobileNumbers: [agentFormik?.values?.mobileNumber],
      });
      if (req && userData?._id) {
        agentFormik.resetForm();
        dispatch(fetchAgentById(userData?._id));
        setDisableBtn(false);
      } else {
        setDisableBtn(false);
      }
  ...
  const onLoadPhysicalAddress = (autocomplete) => {
    addressRef.current = autocomplete;
  };
  const onChangePhysicalAddress = async () => {
    const place = await addressRef.current.getPlace();
    if (place?.formatted_address) {
      profileFormik.setValues({
        ...profileFormik.values,
  ...
  const handleDeleteAgent = async (userId) => {
    ...
    setDisableBtn(true);
    try {
      await axios.delete(`${BASE_URL}/user/${userId}/agency/${userData?._id}`);
      dispatch(fetchAgentById(userData?._id));
      message.destroy();
      ...
      <div className="content_container">
        <div className="left_container">
          <div className="btn_container d_none">
            ...
            <Link
              href="#profile"
              onClick={() => setSettingbtn(6)}
              className={settingbtn === 6 ? "btnActive" : ""}
            >
              {svg_profile}Profile
            </Link>
            <Link
            ...
            >
              {account_preferences_icon}Agents
            </Link>
            <Link
          ...
          <div className="form_container">
            ...
            <div className="number_field_container">
              ...
              <PhoneInput
                ...
                onBlur={userFormik.handleBlur}
                className={
                  isFieldError("landlineNumber", userFormik)
                    ? "err_field_phone"
                    : ""
                }
                country={"pk"}
            ...
            <div className="number_field_container">
              ...
              <PhoneInput
                ...
                onBlur={userFormik.handleBlur}
                className={
                  isFieldError("mobileNumbers", userFormik)
                    ? "err_field_phone"
                    : ""
                }
                country={"pk"}
            ...
            <div className="number_field_container">
              ...
              <PhoneInput
                ...
                onBlur={userFormik.handleBlur}
                className={
                  isFieldError("whatsapp", userFormik) ? "err_field_phone" : ""
                }
                country={"pk"}
                onlyCountries={["pk"]}
                countryCodeEditable={false}
            ...
            <div className="dual_container">
              <div className="input_field_container">
                <p className="label">Agency Name</p>
                <input
                  type="text"
                  placeholder="Full Name"
                  name="agencyName"
                  value={profileFormik.values?.agencyName}
                  onChange={profileFormik.handleChange}
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("agencyName", profileFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
              ...
              <div className="input_field_container">
                ...
                <input
                  ...
                  value={profileFormik.values.additionalEmail}
                  onChange={profileFormik.handleChange}
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("additionalEmail", profileFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
            ...
            <div className="input_field_container">
              ...
              >
                <>
                  ...
                  <Autocomplete
                    onLoad={onLoadPhysicalAddress}
                    onPlaceChanged={onChangePhysicalAddress}
                    key={MAP_API_KEY}
                    types={["address"]}
                    restrictions={{ country: "PK" }}
                  >
                    <input
                      ...
                      id="physicalAddress"
                      value={profileFormik.values.physicalAddress}
                      onChange={profileFormik.handleChange}
                      onBlur={profileFormik.handleBlur}
                      className={`input_field google_input_field ${
                        isFieldError("physicalAddress", profileFormik) &&
                        "err_field"
                      }`}
                      autoComplete="false"
                    />
              ...
              <div className="input_field_container">
                <>
                  ...
                  <MutiSelect
                    ...
                    onChange={profileFormik?.handleChange}
                    onBlur={profileFormik?.handleBlur}
                    error={isFieldError("serviceAreas", profileFormik)}
                    options={allCitites}
                    labelVal="name"
                    labelKey="name"
                  />
            ...
            <div className="input_field_container ">
              <>
                ...
                <textarea
                  ...
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("description", profileFormik)
                      ? "err_field input_field About_textarea"
                      : "input_field About_textarea"
                  }
                />
              </>
            </div>
            <div className="dual_container">
              ...
              <div className="input_field_container">
                <>
                  <p className="label">Property For</p>
                  <MutiSelect
                    placeholder="Enter your current country"
                    name="propertyFor"
            ...
            <div className="number_field_container">
              <p className="label">Additional Mobile Number</p>
              <PhoneInput
                name="additionalMobileNumber"
                value={profileFormik.values.additionalMobileNumber}
                onChange={(val) =>
                  profileFormik.handleChange({
                    target: { name: "additionalMobileNumber", value: val },
                  })
                }
                onBlur={profileFormik.handleBlur}
                className={
                  isFieldError("additionalMobileNumber", profileFormik)
                    ? "err_field_phone"
                    : ""
                }
                country={"pk"}
            ...
            <div className="number_field_container">
              <p className="label">Additional WhatsApp</p>
              <PhoneInput
                name="additionalwhatsapp"
                value={profileFormik.values.additionalwhatsapp}
                onChange={(val) =>
                  profileFormik.handleChange({
                    target: { name: "additionalwhatsapp", value: val },
                  })
                }
                onBlur={profileFormik.handleBlur}
                className={
                  isFieldError("additionalwhatsapp", profileFormik)
                    ? "err_field_phone"
                    : ""
                }
                country={"pk"}
            ...
            <div className="select_field_container">
              ...
              <div className="styles_select">
                <select
                  ...
                  value={profileFormik.values.verificationType}
                  onChange={profileFormik.handleChange}
                  onBlur={profileFormik.handleBlur}
                  className={
                    isFieldError("verificationType", profileFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                >
            ...
            <div className="upload_field_container">
              <p className="label">Upload a Logo</p>
              <div
                className={`upload_btn ${
                  isFieldError("agencyLogo", profileFormik) ? "err_field" : ""
                }`}
              >
                <Upload {...LogoProps} disabled={disbleBtn}>
                  <Button disabled={disbleBtn} icon={<UploadOutlined />}>
                    Browse and Upload
                  </Button>
                </Upload>
              </div>
              <p className="label">Upload a Cover Picture</p>
              <div
                className={`upload_btn ${
                  isFieldError("agencyCoverPicture", profileFormik)
                    ? "err_field"
                    : ""
                }`}
              >
                <Upload {...CoverImage} disabled={disbleBtn}>
                  <Button disabled={disbleBtn} icon={<UploadOutlined />}>
                    Browse and Upload
                  </Button>
                </Upload>
            ...
            <div className="dual_container">
              <div className="input_field_container">
                ...
                <input
                  ...
                  name="ceoName"
                  value={ceoFormik.values.ceoName}
                  onChange={ceoFormik.handleChange}
                  className={
                    isFieldError("ceoName", ceoFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
              ...
              <div className="input_field_container">
                ...
                <input
                  type="text"
                  placeholder="Enter CEO Designation"
                  name="ceoDesignation"
                  value={ceoFormik.values.ceoDesignation}
                  onChange={ceoFormik.handleChange}
                  className={
                    isFieldError("ceoDesignation", ceoFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
            ...
            <div className="input_field_container">
              ...
              <textarea
                ...
                name="ceoMessage"
                value={ceoFormik.values.ceoMessage}
                onChange={ceoFormik.handleChange}
                className={
                  isFieldError("ceoMessage", ceoFormik)
                    ? "err_field input_field About_textarea"
                    : "input_field About_textarea"
                }
              />
            ...
            <div className="upload_field_container">
              ...
              <div
                className={`upload_btn ${
                  isFieldError("ceoPicture", ceoFormik) ? "err_field" : ""
                }`}
              >
                <Upload {...ceoImage} disabled={disbleBtn}>
                  <Button disabled={disbleBtn} icon={<UploadOutlined />}>
                    Browse and Upload
                  </Button>
                </Upload>
            ...
            <button
              ...
              style={{ marginTop: "0px" }}
              disabled={disbleBtn}
              onClick={ceoFormik.handleSubmit}
            >
              {" "}
              Submit
            </button>
            <div className="divider" />
            <>
              <h3 className="form_heading" id="agents">
                Agents
              </h3>
              <div className="dual_container">
                <div className="input_field_container">
                  ...
                  <input
                    ...
                    name="username"
                    value={agentFormik.values.username}
                    onChange={agentFormik.handleChange}
                    className={
                      isFieldError("username", agentFormik)
                        ? "err_field input_field"
                        : "input_field"
                    }
                  />
                ...
                <div className="input_field_container">
                  ...
                  <input
                    ...
                    onChange={agentFormik.handleChange}
                    className={
                      isFieldError("email", agentFormik)
                        ? "err_field input_field"
                        : "input_field"
                    }
                  />
              ...
              <div className="input_field_container">
                ...
                <input
                  ...
                  onChange={agentFormik.handleChange}
                  className={
                    isFieldError("password", agentFormik)
                      ? "err_field input_field"
                      : "input_field"
                  }
                />
              ...
              <div className="number_field_container">
                ...
                <PhoneInput
                  name="mobileNumber"
                  value={agentFormik.values.mobileNumber}
                  onChange={(val) =>
                    agentFormik.handleChange({
                      target: { name: "mobileNumber", value: val },
                    })
                  }
                  onBlur={agentFormik.handleBlur}
                  className={
                    isFieldError("mobileNumber", agentFormik)
                      ? "err_field_phone"
                      : ""
                  }
                  country={"pk"}
              ...
              <button
                ...
                style={{ marginTop: "0px" }}
                disabled={disbleBtn}
                onClick={agentFormik.handleSubmit}
              >
                {" "}
                Add Agent
              </button>
              ...
              <div className="staff_container">
                <h3 className="staff_label">Manage Agents</h3>
            ...
            <div className="input_field_container">
              ...
              <input
                ...
                className={
                  ...
                  userChangeFormik.touched?.oldPassword
                    ? "err_field input_field"
                    : "input_field"
                }
              />
            ...
            <div className="input_field_container">
              ...
              <input
                ...
                className={
                  ...
                  userChangeFormik.touched?.newPassword
                    ? "err_field input_field"
                    : "input_field"
                }
              />
            ...
            <div className="input_field_container">
              ...
              <input
                ...
                className={
                  ...
                  userChangeFormik.touched?.confirmPassword
                    ? "err_field input_field"
                    : "input_field"
                }
              />
...
export default AgencyAccountSetting;
